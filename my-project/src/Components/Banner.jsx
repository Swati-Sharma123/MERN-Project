        ...
        <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
            <div className='w-full md:w-1/2 mt-12 md:mt-32 '>
               <div className='space-y-12'>
                  ...
                  <p className='text-xl'>A book is a medium for recording information in the form of writing or images. It is typically composed of many pages, bound together and protected by the pasrt of cover. 
                  </p>
